  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-6 md:mb-8 text-glow">Ready to Embark on Your Journey?</h2>
        <p className="max-w-2xl mx-auto mb-6 md:mb-8 text-base md:text-lg px-4">
          The Time Machine is ready for your instructions. Where and when would you like to travel?
        </p>
        <button
          onClick={onTimeTravel}
          className="px-6 md:px-10 py-3 md:py-4 bg-time-accent text-white text-base md:text-lg rounded-md font-medium 
