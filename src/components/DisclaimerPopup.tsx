        ...
        <>
          ...
          <motion.div
            ...
            className={cn(
              ...
              "mx-auto my-0" // Added to ensure proper centering
            )}
            style={{
          ...
          >
            ...
            <h2 className="font-serif text-xl sm:text-2xl font-bold mb-3 bg-gradient-to-r from-time-accent to-white bg-clip-text text-transparent">
              Time Travel Notice
            </h2>
            
            <p className="mb-5 text-sm sm:text-base text-slate-200 leading-relaxed">
            ...
            <div className="flex justify-center mt-6">
              <motion.button
                ...
                onClick={onAccept}
                className={cn(
                  "relative overflow-hidden py-2 sm:py-3 px-6 sm:px-8 rounded-full font-medium",
                  ...
                  "text-sm sm:text-base" // Add responsive text sizing
                )}
              >
