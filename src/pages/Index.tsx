  ...
  return <div className={cn("min-h-screen flex flex-col transition-opacity duration-700", isLoaded ? "opacity-100" : "opacity-0")}>
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 py-20 md:py-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-white space-y-6 max-w-2xl">
              ...
              <p ref={addToRefs} className="reveal text-lg text-white/80 max-w-xl">
              ...
              <div ref={addToRefs} className="reveal flex flex-col sm:flex-row gap-4 pt-4">
            ...
            <div ref={addToRefs} className="reveal lg:mr-0 lg:-mt-20 lg:ml-0">
              <TimePortal onStartJourney={handleStartJourney} timeDestinationUrl={TIME_MACHINE_URL} className="max-w-md mx-auto lg:mr-0" />
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-b from-time-dark to-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
            ...
            image: "bg-[url('https://images.unsplash.com/photo-1492321936769-b49830bc1d1e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1740&q=80')]"
          }].map((era, index) => <div key={index} ref={addToRefs} className="reveal rounded-xl overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105">
                ...
                <div className="p-6 bg-white">
                  ...
                  <a href={TIME_MACHINE_URL} target="_blank" rel="noopener noreferrer" className="mt-4 px-4 py-2 border border-time-medium text-time-medium rounded hover:bg-time-medium hover:text-white transition-colors inline-block">
                    Explore This Era
                  </a>
                </div>
              </div>)}
